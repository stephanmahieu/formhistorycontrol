...
const FhcPreferencesOverlay = {
  ...
  addFormHistoryButton: function() {
    ...
    if (null!=newBox && null!=rememberFormsCheckbox && !("true"==rememberFormsCheckbox.getAttribute("isExtended"))) {
      // unhide the new box containing the formhistory button
      newBox.setAttribute("hidden", false);

      // move the box into the desired position
      ...
      newBox.insertBefore(rememberFormsCheckbox, formhistButton);
          
      // set flag to indicate that button has already been added
      rememberFormsCheckbox.setAttribute("isExtended", "true");
    }
  }
}

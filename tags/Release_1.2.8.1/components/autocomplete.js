// Source: https://developer.mozilla.org/en/How_to_implement_custom_autocomplete_search_component
...
SimpleAutoCompleteResult.prototype = {
  ...
  QueryInterface: function(aIID) {
    if (!aIID.equals(Components.interfaces.nsIAutoCompleteResult) && !aIID.equals(Components.interfaces.nsISupports))
...
SimpleAutoCompleteSearch.prototype = {
  ...
  startSearch: function(searchString, searchParam, result, listener) {
    ...
    if (searchParam.length > 0) {
      ...
      var newResult = new SimpleAutoCompleteResult(searchString, Components.interfaces.nsIAutoCompleteResult.RESULT_SUCCESS, 0, "", results, comments);
  ...
  QueryInterface: function(aIID) {
    if (!aIID.equals(Components.interfaces.nsIAutoCompleteSearch) && !aIID.equals(Components.interfaces.nsISupports))
        throw Components.results.NS_ERROR_NO_INTERFACE;
    return this;
  }
};

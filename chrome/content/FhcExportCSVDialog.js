 ...
 * License.
 *
 * The Original Code is FhcExportCSVDialog.
 *
...
/**
 * Methods for the form history export dialog.
 * Only used within FhcExportCSVDialog.xul, thus no danger of namespace conflicts.
 *
...
var FhcExportCSVDialog = {
   ...
   */
  setChoices: function() {
    document.getElementById("selectedhist").disabled = !this.haveSelectedHist;
    document.getElementById("searchhist").disabled = !this.haveFilteredHist;
  },
